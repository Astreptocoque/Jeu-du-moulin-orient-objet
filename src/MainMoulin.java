...
public class MainMoulin {
	...
	public static void main(String[] args) throws IOException {
		...
		plateau.mapCases.get(14).pion = Pion.noir;
		plateau.mapCases.get(15).pion = Pion.noir;
		plateau.mapCases.get(16).pion = Pion.blanc;
		plateau.mapCases.get(17).pion = Pion.blanc;
		plateau.mapCases.get(18).pion = Pion.noir;
